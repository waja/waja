...
- [Remove parseable, which is not valid since ansible-lint &gt;5](https://github.com/waja/ansible-role-docker-config/pull/8) on [waja/ansible-role-docker-config](https://github.com/waja/ansible-role-docker-config) (3 days ago)
- [Remove parseable, which is not valid since ansible-lint &gt;5](https://github.com/waja/ansible-role-docker-servicestack/pull/13) on [waja/ansible-role-docker-servicestack](https://github.com/waja/ansible-role-docker-servicestack) (3 days ago)
- [Remove parseable, which is not valid since ansible-lint &gt;5](https://github.com/waja/ansible-role-docker-tools/pull/12) on [waja/ansible-role-docker-tools](https://github.com/waja/ansible-role-docker-tools) (3 days ago)
- [Adding Change2Log plugin](https://github.com/tmtde/docker-netbox/pull/194) on [tmtde/docker-netbox](https://github.com/tmtde/docker-netbox) (5 days ago)
