...
- [waja/docker-calcardbackup](https://github.com/waja/docker-calcardbackup) - Docker image for calcardbackup: https://codeberg.org/BernieO/calcardbackup (3 days ago)
...
- [monitoring-plugins/monitoring-plugins](https://github.com/monitoring-plugins/monitoring-plugins) - A suite of Monitoring Plugins (formerly known as nagios-plugins) (3 days ago)
...
- [jitsi/docker-jitsi-meet](https://github.com/jitsi/docker-jitsi-meet) ([stable-11146-1](https://github.com/jitsi/docker-jitsi-meet/releases/tag/stable-11146-1), 1 day ago) - Jitsi Meet on Docker
- [monitoring-plugins/monitoring-plugins](https://github.com/monitoring-plugins/monitoring-plugins) ([v3.0.2](https://github.com/monitoring-plugins/monitoring-plugins/releases/tag/v3.0.2), 1 week ago) - A suite of Monitoring Plugins (formerly known as nagios-plugins)
- [waja/backuppc-helper](https://github.com/waja/backuppc-helper) ([debian/0.2.0](https://github.com/waja/backuppc-helper/releases/tag/debian/0.2.0), 2 weeks ago) - helper scripts used by backuppc to create LVM snapshots
...
- [fix: Remove heading part of string, to have it more predictable](https://github.com/waja/docker-calcardbackup/pull/207) on [waja/docker-calcardbackup](https://github.com/waja/docker-calcardbackup) (3 days ago)
- [Revert &#34;Use tag 4.0.2, which is the latest version compatible below 5.0&#34;](https://github.com/tmtde/docker-netbox/pull/265) on [tmtde/docker-netbox](https://github.com/tmtde/docker-netbox) (6 days ago)
