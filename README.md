...
- [waja/maldetect](https://github.com/waja/maldetect) - Debian packaging of Linux Malware Detect (https://github.com/rfxn/linux-malware-detect) (today)
- [waja/config-apt-update](https://github.com/waja/config-apt-update) - package for automatical Debian update notification via mail (today)
...
- [waja/pkg-monitoring-plugins](https://github.com/waja/pkg-monitoring-plugins) - Mirror of the Debian momitoring-plugins package http://packages.qa.debian.org/monitoring-plugins (today)
...
- [monitoring-plugins/monitoring-plugins](https://github.com/monitoring-plugins/monitoring-plugins) ([v3.0.0-rc3](https://github.com/monitoring-plugins/monitoring-plugins/releases/tag/v3.0.0-rc3), 3 weeks ago) - A suite of Monitoring Plugins (formerly known as nagios-plugins)
...
- [chore: update Nextcloud to 32.0.9](https://github.com/hoellen/docker-nextcloud/pull/164) on [hoellen/docker-nextcloud](https://github.com/hoellen/docker-nextcloud) (5 days ago)
- [chore: update Nextcloud to 33.0.3](https://github.com/hoellen/docker-nextcloud/pull/163) on [hoellen/docker-nextcloud](https://github.com/hoellen/docker-nextcloud) (5 days ago)
